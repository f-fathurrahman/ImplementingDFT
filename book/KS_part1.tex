...
\end{juliacode}
In the function \jlinline{o_H}, first we apply the kinetic matrix by using the
...
\begin{center}
\includegraphics[scale=1.0]{../codes/hartree_scf/LOG_files/IMG_H.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale=1.0]{../codes/hartree_scf/LOG_files/IMG_H2.pdf}
\end{center}
...
{\centering
\includegraphics[scale=1.0]{../codes/ks_dft_02/LOG_files/IMG_H.pdf}
}
...
{\centering
\includegraphics[scale=1.0]{../codes/ks_dft_02/LOG_files/IMG_H2.pdf}
}
