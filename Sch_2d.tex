\chapter{Numerical solution of Schroedinger equation in 2d}
...
\begin{figure}[H]
{\center
\includegraphics[scale=0.75]{codes/2d/IMG_gaussian2d.pdf}
\includegraphics[scale=0.75]{codes/2d/IMG_d2_gaussian2d.pdf}
\par}
